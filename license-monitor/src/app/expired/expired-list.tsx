...
interface ExpiredListProps {
  licenses: LicenseEntry[];
}

export function ExpiredList({ licenses }: ExpiredListProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      {Array.from(workerMap.values()).map(({ worker, licenses: workerLicenses }) => (
